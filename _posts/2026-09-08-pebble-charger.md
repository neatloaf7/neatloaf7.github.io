...
tags:
    - "Electronics"
excerpt: A less than safe workaround for a broken Pebble charger
header:
    teaser: "/assets/images/pebble/pic.jpg"
---
UPDATE:
I found a schematic of the charger posted on reddit [here](https://www.reddit.com/r/pebble/comments/1p2mz2f/comment/npzqyj7/?utm_source=share&utm_medium=web3x&utm_name=web3xcss&utm_term=1&utm_content=share_button). The two pulldown resistors on CC1 and CC2 negoitate with "smart" USB C power supplies for 5V, and the blue IC appears to be for overcurrent protection. My workaround bypasses several safety features, but I believe monitoring the watch while charging and connecting the dongle to the watch before plugging it in will mitigate some risk.
{% include figure popup=false image_path="/assets/images/pebble/schem.jpeg" caption="Charger schematic" %}
---
My Pebble Time 2 stopped charging today and I figured out the charging dongle that came with the watch somehow broke. The pogo pins (+) and magnets (-) were shorted together when checking with a multimeter. Searching online shows that I am not the first person for this to happen to, and that Pebble support will generally help you out with a new charger. While waiting for that, I opened up the charger and figured the small IC on the board was shorted somewhere, as the 5V and GND pads on the USB C port were not shorted. 
...
{% include figure popup=false image_path="/assets/images/pebble/pic.jpg" caption="The workaround" %}
